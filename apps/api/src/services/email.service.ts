        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;">
          <tr>
            <td align="center" style="background-color: #09090b; border-radius: 16px; padding: 16px;">
              <img src="https://raw.githubusercontent.com/zaynbaluch/scribe.ai/main/apps/web/public/logo-light.png" alt="Scribe" width="56" height="56" style="border:0; display:block;">
            </td>
          </tr>
        </table>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #050508;">
    <tr>
      <td align="center" style="padding: 80px 24px;">
        ...
        <p style="color: #a1a1aa; font-size: 16px; margin: 0 0 48px; line-height: 1.6; max-width: 320px; padding: 0 20px;">Lost your access? No worries. Use the recovery code below to set a new password.</p>
        
        <div style="margin-bottom: 48px;">
          <span class="code-display" style="font-size: 48px; font-weight: 700; color: #f59e0b; letter-spacing: 0.2em; font-family: 'Courier New', Courier, monospace;">{{code}}</span>
        </div>
...
<body style="font-family: sans-serif; background-color: #050508; color: #fff;">
  <center>
    <img src="https://raw.githubusercontent.com/zaynbaluch/scribe.ai/main/apps/web/public/logo-light.png" alt="Scribe" width="56" height="56" style="margin: 40px 0;">
    <h1>Follow up?</h1>
