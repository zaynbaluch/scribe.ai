...
var __privateMethod = (obj, member, method) => (__accessCheck(obj, member, "access private method"), method);
  ...
  function scrapeLinkedInJob() {
    ...
    const title = ((_b2 = (_a2 = document.querySelector(".job-details-jobs-unified-top-card__job-title, .t-24.t-bold")) == null ? void 0 : _a2.textContent) == null ? void 0 : _b2.trim()) || "";
    const company = ((_d = (_c = document.querySelector(".job-details-jobs-unified-top-card__company-name, .job-details-jobs-unified-top-card__primary-description a")) == null ? void 0 : _c.textContent) == null ? void 0 : _d.trim()) || "";
    let location2 = "";
    const locationEl = document.querySelector(".job-details-jobs-unified-top-card__primary-description span:nth-child(2)");
    if (locationEl) location2 = ((_e = locationEl.textContent) == null ? void 0 : _e.trim()) || "";
    const descriptionEl = document.querySelector("#job-details, .jobs-description__content");
    const rawDescription = ((_f = descriptionEl == null ? void 0 : descriptionEl.textContent) == null ? void 0 : _f.trim()) || "";
    return {
      title,
      company,
      location: location2,
  ...
  function getUniqueEventName(eventName) {
    const entrypointName = typeof __vite_import_meta_env__ === "undefined" ? "build" : "linkedin";
  ...
  var result = (async () => {
    try {
      ...
      const ctx = new ContentScriptContext("linkedin", options);
      return await main(ctx);
    } catch (err) {
      logger.error(
        `The content script "${"linkedin"}" crashed on startup!`,
        err
      );
      throw err;
    }
