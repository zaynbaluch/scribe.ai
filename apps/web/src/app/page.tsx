      ...
      <main className="flex-1">
        <section className="relative pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <a href="https://github.com/zaynbaluch/scribe.ai" target="_blank" rel="noreferrer" className="px-8 py-4 text-white rounded-xl text-base font-semibold border border-white/10 bg-white/5 hover:bg-white/10 transition-colors flex items-center gap-2">
