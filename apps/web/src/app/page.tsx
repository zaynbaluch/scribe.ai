  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0a0f] text-[#e4e4e7] overflow-x-hidden selection:bg-[var(--gradient-2)] selection:text-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative z-10 bg-[#0a0a0f] py-24 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="w-full relative rounded-2xl border border-white/10 bg-[#18181b] shadow-2xl overflow-hidden group">
        ...
        {/* Features Bento Grid */}
        <section id="features" className="py-24 relative z-10 bg-[#0a0a0f] border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 col-span-1 rounded-3xl bg-[#18181b]/50 border border-white/10 p-8 flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="absolute right-0 bottom-0 opacity-20 group-hover:opacity-40 transition-opacity">
                <div className="w-64 h-64 bg-[var(--gradient-2)] rounded-full blur-[100px]" />
              </div>
            </div>
        ...
        {/* CTA */}
        <section className="py-24 px-6 relative border-t border-white/5 overflow-hidden bg-[#0a0a0f] z-10">
          ...
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <Link href="/login" className="inline-flex px-4 py-2 rounded-lg text-sm font-semibold bg-white text-black hover:bg-white/90 transition-colors">
      ...
      <footer className="border-t border-white/10 py-12 px-6 md:px-12 relative z-10 bg-[#0a0a0f]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <Link href="/" className="flex items-center gap-2 group">
            <Logo size={18} className="text-white group-hover:rotate-12 transition-transform" />
