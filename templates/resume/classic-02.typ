...
#for section in sections {
  ...
  if section == "summary" {
    ...
    if summary != none and summary != "" {
      section-heading("Professional Summary", accent: accent, style: "classic")
      text(size: 10pt, fill: luma(30))[#summary]
    }
  }
  ...
  if section == "experience" {
    ...
    if exps.len() > 0 {
      section-heading("Professional Experience", accent: accent, style: "classic")
      for exp in exps {
        entry-header(
  ...
  if section == "education" {
    ...
    if edu.len() > 0 {
      section-heading("Education", accent: accent, style: "classic")
      for e in edu {
        entry-header(
          e.at("degree", default: "") + if e.at("field", default: "") != "" { ", " + e.field } else { "" },
  ...
  if section == "skills" {
    ...
    if skills.len() > 0 {
      section-heading("Technical Skills", accent: accent, style: "classic")
      skill-list(skills)
    }
  }
  ...
  if section == "certifications" {
    ...
    if certs.len() > 0 {
      section-heading("Certifications", accent: accent, style: "classic")
      for c in certs {
